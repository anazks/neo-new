...
const TicketManagement = () => {
  ...
  const handleTicketSelect = (ticket) => {
    ...
    setActiveTab("RESOLUTION"); // Reset to default tab
  };
  ...
  const tabContent = {
    RESOLUTION: (
      <div className="space-y-2">
        <h3 className="text-sm font-bold font-['Rajdhani',_sans-serif]">Resolution Details</h3>
        <p className="text-xs sm:text-sm font-['Raleway',_sans-serif] leading-relaxed">
          {selectedTicket?.grievance || "No resolution content available."}
        </p>
      </div>
    ),
    DEVICE: (
    ...
    CONCLUSION: (
      <div className="space-y-2">
        <h3 className="text-sm font-bold font-['Rajdhani',_sans-serif]">Final Resolution</h3>
        <p className="text-xs sm:text-sm font-['Raleway',_sans-serif] leading-relaxed">
          {selectedTicket?.conclusion || "No conclusion available."}
        </p>
      </div>
    ),
  };
                      ...
                      <div className="mb-6">
                        ...
                        <div className="relative">
                          ...
                          <textarea
                            ...
                            className="w-full p-3 bg-transparent text-sm resize-none outline-none font-['Raleway',_sans-serif] min-h-[168px]"
                            style={{
                      ...
                      <button
                        className={`w-full py-3 bg-[#63a375] text-white font-['Courier_New',_monospace] rounded-lg transition-all duration-200 ${
                          isSubmitting 
                            ...
                            : "hover:bg-[#5a9369] hover:shadow-md"
                        }`}
