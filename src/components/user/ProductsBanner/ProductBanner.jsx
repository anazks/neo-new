...
function ProductBanner() {
  ...
  return (
    <>
      ...
      <div className={`w-full max-w-6xl mx-auto mt-10 md:mt-16 flex flex-col md:flex-row justify-around gap-5 relative z-10 p-4 transition-colors duration-300 ${darkMode ? 'text-white bg-gray-900 rounded-xl' : ''}`}>
        ...
        <div className="w-full md:hidden block h-auto relative mb-8">
          <div className="relative w-full h-full">
            ...
            <div className="absolute top-1/4 left-1/4 w-3 h-3 bg-purple-600 rounded-full animate-pulse-ring">
              <span className="absolute -top-10 -left-2 bg-black/70 text-white text-xs p-1 rounded opacity-0 group-hover:opacity-100 transition-opacity">CPU</span>
            </div>
            <div className="absolute top-1/2 right-1/4 w-3 h-3 bg-cyan-500 rounded-full animate-pulse-ring">
              <span className="absolute -top-10 -left-2 bg-black/70 text-white text-xs p-1 rounded opacity-0 group-hover:opacity-100 transition-opacity">GPU</span>
            </div>
          </div>
        </div>
        ...
        <div className="w-full md:w-1/2 flex flex-col items-start relative p-0 md:p-5">
          ...
          <div className="smallText w-full max-w-xl h-auto my-5 mx-auto opacity-0 translate-y-5 transition-all duration-600 delay-400">
            <div className="flex items-center my-2 p-2 rounded-lg transition-all duration-300 hover:bg-purple-600/10 hover:translate-x-1">
              ...
              <span className="text-base sm:text-lg font-rajdhani">Intel Core i7 14700K - 5.6GHz Max Clock</span>
            </div>
            <div className="flex items-center my-2 p-2 rounded-lg transition-all duration-300 hover:bg-purple-600/10 hover:translate-x-1">
              <FaFire className="mr-2 text-purple-600 text-lg" />
              <span className="text-base sm:text-lg font-rajdhani">Nvidia RTX 4070Ti - 8GB DDR6 VRAM</span>
            </div>
            <div className="flex items-center my-2 p-2 rounded-lg transition-all duration-300 hover:bg-purple-600/10 hover:translate-x-1">
              <FaMemory className="mr-2 text-purple-600 text-lg" />
              <span className="text-base sm:text-lg font-rajdhani">Corsair Vengeance DDR5 - 16GB</span>
            </div>
            <div className="flex items-center my-2 p-2 rounded-lg transition-all duration-300 hover:bg-purple-600/10 hover:translate-x-1">
              <FaHardDrive className="mr-2 text-purple-600 text-lg" />
              <span className="text-base sm:text-lg font-rajdhani">Samsung 970 Evo Pro - 1TB</span>
            </div>
          </div>
          
          <div className="rate text-center relative p-2 my-5 opacity-0 scale-90 transition-all duration-600 delay-600">
            <span className="text-xl sm:text-2xl font-raleway line-through">₹2,77,990</span> 
            <span className="text-xl sm:text-2xl font-raleway font-bold ml-2 inline-block relative">₹2,57,990</span>
        ...
        <div className="hidden md:block w-full md:w-[45%] max-w-lg h-auto relative">
          <div className="relative w-full h-full group">
            ...
            <div className="absolute bottom-1/4 left-1/3 w-3 h-3 bg-green-500 rounded-full animate-pulse-ring cursor-pointer">
              <span className="absolute -top-10 -left-2 bg-black/70 text-white text-xs p-1 rounded opacity-0 group-hover:opacity-100 transition-opacity">SSD</span>
            </div>
          </div>
        </div>
      </div>
