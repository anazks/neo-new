      ...
      <div className="flex-1 flex flex-col w-full overflow-hidden">
            ...
            <div className="w-full h-full relative overflow-hidden">
              ...
              >
                <img 
                  ...
                  className="w-full h-full object-contain rounded-lg transition-all duration-600 hover:scale-105"
                />
        ...
        <div className={`w-full relative ${isDarkMode ? 'bg-gray-800' : 'bg-gray-100'} rounded-lg mb-3 p-2 flex-1`}>
          ...
          <div 
            ...
            className="flex overflow-x-auto scrollbar-hide snap-x snap-mandatory gap-2 py-2 px-1 w-full h-full items-center"
            style={{ scrollbarWidth: 'none', msOverflowStyle: 'none' }}
          >
            {currentSpecs.map((spec, index) => (
              <div 
                key={index} 
                className={`${isDarkMode ? 'bg-gray-700' : 'bg-white'} rounded-lg flex-shrink-0 flex flex-col items-center justify-center p-3 transition-all duration-300 shadow-sm hover:shadow-lg text-center snap-start w-36 h-full`}
              >
