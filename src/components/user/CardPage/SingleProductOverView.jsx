                            ...
                            <div className="divide-y divide-gray-200">
                                <div className="py-4 flex flex-col sm:flex-row justify-between">
                                    <div className="flex items-center mb-2 sm:mb-0">
                                        <div className="h-12 w-12 bg-gray-100 rounded-md flex items-center justify-center mr-4 overflow-hidden">
                                            {product.primary_image && product.primary_image.length > 0 ? (
                                                <img src={BaseURL + product.primary_image[0].image} alt={product.name} className="object-cover" />
                                            ) : (
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm text-gray-500">Available: {product.stock || 'N/A'}</p>
                                        </div>
                                    </div>
                                    <div className="flex items-center justify-between sm:items-end sm:flex-col">
                                        ...
                                        <span className="font-medium">INR. {product.price * quantity}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="sticky top-6">
                            ...
                            <div className="mb-6 bg-gray-50 rounded-lg p-6 shadow-sm">
                                ...
                                <div className="space-y-3 text-sm">
                                    ...
                                    <div className="flex justify-between">
                                        ...
                                        <span className="font-medium">INR. {shipping.toFixed(2)}</span>
                                    </div>
                                    <div className="flex justify-between">
                                    ...
                                    <div className="border-t border-gray-200 pt-3 mt-3">
                                        <div className="flex justify-between text-base font-medium">
                                            ...
                                            <span className="text-blue-600">INR. {total.toFixed(2)}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <button 
                                ...
                                className={`w-full bg-blue-600 text-white py-4 px-6 rounded-lg font-medium flex items-center justify-center transition-colors duration-300 shadow-sm ${
                                    !selectedAddressId ? 'opacity-50 cursor-not-allowed' : 'hover:bg-blue-700'
                                }`}
