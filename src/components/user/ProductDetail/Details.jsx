    ...
    <>
      ...
      <div className="pt-20 min-h-screen bg-gradient-to-br from-gray-50 to-white text-gray-800">
        ...
        <div className="max-w-6xl mx-auto px-4 py-8 flex flex-col md:flex-row md:items-start gap-8 opacity-0 translate-y-8 animate-fade-up">
          ...
          <div
            className="w-full md:w-2/5 md:sticky md:top-20 self-start"
            ref={imageRef}
          >
            {/* Image container */}
              ...
              {productImage ? (
                <div className="relative h-72 flex items-center justify-center">
                  <img
                    ...
                    className={`w-full h-auto object-contain max-h-72 rounded-lg transform transition-all duration-500 ${
                      imageLoaded
            ...
            <div className="mt-4 flex flex-wrap gap-3 justify-center md:justify-start items-center">
              ...
              {product.images.map((obj, index) => (
                <div
                  key={index}
                  className="w-20 h-20 overflow-hidden rounded border shadow-sm"
                >
                  <img
                ...
                {/* Video thumbnails using the new component */}
              {productVideos.length > 0 && <VideoThumbnail videos={productVideos} />}
          ...
          >
            ...
            <div className="mb-6">
              <h3 className="relative uppercase tracking-wider text-xs pl-3 mb-3 font-medium text-gray-500 before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:w-1 before:h-3 before:bg-gradient-to-r before:from-red-500 before:to-pink-400">
                {product.category || "GAMING PC"} <span className="text-pink-600">||</span> {product.brand}
              </h3>

              <h1
                className="text-2xl md:text-3xl font-bold mb-1 uppercase tracking-tight text-gray-800"
              ...
              >
                ...
                <span className="ml-5">
                  <del
                    className="text-base mr-3 font-normal text-gray-400 align-super"
                    style={{ fontFamily: "Rajdhani, sans-serif" }}
                  >
              ...
              <div
                className="text-2xl font-bold mb-3 pb-3 text-gray-800"
                style={{ fontFamily: "Rajdhani, sans-serif" }}
              >
            ...
            <div
              className="text-sm leading-relaxed mb-4 pb-4 text-gray-600"
              style={{ fontFamily: "Rajdhani, sans-serif" }}
            >
              {product.description ||
