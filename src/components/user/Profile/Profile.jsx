...
function UserProfile() {
  ...
  const getAddress = async () => {
    try {
      const address = await getMyDeliveryAddress();
      setUserAddresses(address.data);
    } catch (error) {
      console.log(error);
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.patch('/api/profile/update/', formDataToSend, {
        headers: {
      ...
      if (response.data) {
        ...
        localStorage.setItem('userProfile', JSON.stringify({...userData, ...response.data}));
  ...
  const getProfilePicture = () => {
    if (previewImage) {
      ...
      return userData.profile_picture; // URL to the uploaded profile picture
    } else if (userData.profile_picture_url) {
      return userData.profile_picture_url; // Google profile picture URL
    } else {
      return null; // Will show the User icon as fallback
    }
  };
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            <div className="flex justify-between items-center mb-4">
              ...
              <button className="flex items-center px-4 py-1.5 bg-red-500 text-white rounded-full hover:bg-red-600 transition-all">
            ...
            {userAddresses && userAddresses.length > 0 ? (
              ...
              <div className="text-center py-8 bg-gray-50 rounded-lg">
                ...
                <button className="mt-3 px-4 py-1.5 bg-red-500 text-white text-sm rounded-full hover:bg-red-600 transition-all">
